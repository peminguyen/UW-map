 ...
 */
public class Path<P> implements Iterable<Path<P>.Segment>, Comparable<Path<P>> {
    ...
    /**
     * Create a copy of another path
     *
     * @param other the path to be copied from
     */
    public Path(Path<P> other){
    ...
    public Path<P> extend(P newEnd, double segmentCost) {
        ...
        extendedPath.path.add(new Path<P>.Segment(this.getEnd(), newEnd, segmentCost));
    ...
    /**
     * @return a list of all the segments in the path
     */
    public List<Path<P>.Segment> getList(){
    ...
    /**
     * Return the result of comparing two Path's
     * @return positive if the cost of the current path is more than that of the path to be compared,
     * zero if equal and negative if less than
     */
    @Override
    public int compareTo(Path<P> o) {
    ...
    public class Segment {
        ...
        /**
         * Compare two Segment's.
         * @param obj the object to be compared
         * @return true if they have the same start, same end and same cost
